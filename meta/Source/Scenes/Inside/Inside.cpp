	...
	m_eInsideState(STATE_Inactive)
{
	...
	m_Sensor_Computer.alpha.Set(0.5f);
	...
	m_Sensor_Kitchen.alpha.Set(0.5f);
	...
	m_Sensor_Homework.alpha.Set(0.5f);
	...
	m_Wall_UpperKitchen.alpha.Set(0.5f);
	...
	m_Wall_UpperMain.alpha.Set(0.5f);
	...
	m_Wall_UpperComputer.alpha.Set(0.5f);
	...
	m_Wall_KitchenCounter.alpha.Set(0.5f);
	...
	m_Wall_LowRight.alpha.Set(0.5f);
